...
from backorder_project.entity import DataIngestionArtifact, DataIngestionConfig
from backorder_project.logger import logging


#loading an already cleaned and filtered with top and bottom 100k rows as big dataset taking alot of time
